...
ลองรัน /setup-helper อีกครั้งหลังติดตั้งเสร็จ
```
...
- บอก: "ดูจบแล้วเรียก /setup-helper อีกครั้งถ้าอยาก install"
...
หลัง guide ครบทุก step ที่ขาด — ขอให้ user รัน `/setup-helper` อีกครั้งเพื่อ verify
...
ใช้ไม่ได้/เจอ error → /setup-helper อีกที
